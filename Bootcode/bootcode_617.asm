...
;
;
; V6.16: Modded the SD card driver to workaround a bug in the OSCA emulator. Not an issue on real V6.
;        Reformatted source to Tab size 8
;
; V6.15: Added a short delay after EEPROM sector read to make sure PIC has time to return to waiting
...
; The font data is OK here as it is immediately copied to VRAM before any sector buffer shenanigans
; The initial welcome text is also displayed before the sector buffer is overwritten
;*****************************************************************************************************
...
welcome_txt	db "V6Z80P BY PHIL RUSTON 2008-2012",0
