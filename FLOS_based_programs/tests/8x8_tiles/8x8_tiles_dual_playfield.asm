...
; Tests Extended Tile Mode - Dual Playfield, 8x8 tiles - with priority switch
...
;----------------------------------------------------------------------------------------------
	...
	ld a,%10001001		
	ld (vreg_vidctrl),a		; select 8x8 tile mode / dual pf / normal border 
...
;---------------------------------------------------------------------------------------------------
;copy 128 8x8 tile block definitions to VRAM $00000
;---------------------------------------------------------------------------------------------------
...
;---------------------------------------------------------------------------------------------------
;Write some map data to the Tilemap 0, Playfield B
;---------------------------------------------------------------------------------------------------
