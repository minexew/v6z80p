...
linecop_prog	dw lc_sr+$000
	...
	REPT 1000
		...
		dw lc_wr+$00		;set register 0 - the fact that there's so many of these on one line should disable the
					;linecop for the rest of the frame, so the border remains black
	ENDM
		dw lc_wl+$0c0
		dw lc_wr,$0f
