...
demoloop	call wait_dma
	...
	and %11111110
	or %00000001		;start channel 0 playback req
	out (sys_audio_enable),a
	call pause_long
	call pause_long
	...
	in a,(sys_audio_enable)
	and %11111101
	or %00000010		;start channel 1 playback req
	out (sys_audio_enable),a
	call pause_long
	call pause_long
	...
	in a,(sys_audio_enable)
	and %11111011
	or %00000100		;start channel 2 playback req
	out (sys_audio_enable),a
	call pause_long
	call pause_long
	...
	in a,(sys_audio_enable)
	and %11110111
	or %00001000		;start channel 3 playback req
	out (sys_audio_enable),a
	call pause_long
	call pause_long
	...
	cp $76
	jp nz,demoloop		;loop if ESC key not pressed
