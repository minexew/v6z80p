...
kb_rd_test	call kjt_clear_screen
...
kbtest_txt	db 11,"Keyboard tester v3.00",11,11
		db "Press:",11,11
		db "1. To reset keyboard",11
		db "2. To turn on caps lock",11
		db "3. To turn off caps lock",11
		db "4. To send ECHO command",11
		db "5. To do a scancode test",11,11,0
