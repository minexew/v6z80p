...
include "system_equates.asm"
	...
	ret nz
	ld (file_handle1),a			;file handle is returned in A (also. this file has focus)

	ld hl,$8000
	ld b,0
	call kjt_set_load_address		;must specify load address (without it, file goes to $5000)
