...
ball_palette        incbin "flos_based_programs\demos\vectorballs_2\data\rgby_balls_palette.bin"

font_colours        incbin "flos_based_programs\demos\vectorballs_2\data\reflected_font_palette.bin"
...
sin_table           incbin "flos_based_programs\demos\vectorballs_2\data\sin_table.bin"
...
globe               incbin "flos_based_programs\demos\vectorballs_2\data\globe_sin_table.bin"            
                    incbin "flos_based_programs\demos\vectorballs_2\data\globe_sin_table.bin"
                    ds 16,0
                    ds 16,0
                    
                    incbin "flos_based_programs\demos\vectorballs_2\data\globe_cos_table.bin"
                    ds 16,0
                    incbin "flos_based_programs\demos\vectorballs_2\data\globe_sin_table.bin"
                    ds 16,0
...
rgby_ballsprite     incbin "flos_based_programs\demos\vectorballs_2\data\rgby_balls_two_sizes_sprites_packed_v3.bin"
endofrgbybs         db 0

font_tiles          incbin "flos_based_programs\demos\vectorballs_2\data\reflected_font_tiles_packed.bin"
endoffont           db 0
