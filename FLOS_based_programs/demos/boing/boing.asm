...
;--------------------------------------------------------------------------------------
; V5 Boing demo v1.06 - For 50Hz PAL		
; External files must be located in the same V5Z80P dir as the executable
;--------------------------------------------------------------------------------------
...
;-------- Load sprite files  -----------------------------------------------------------------------
	...
	jp nz,load_problem
	ld b,2			;bank 2
	ld hl,sprite_data		;address to load to 
	call kjt_force_load
	jp nz,load_problem
...
;-------- Load tile files  -----------------------------------------------------------------------
	...
	jp nz,load_problem
	ld b,2			;bank 2
	ld hl,tile_data		;address to load to 
	call kjt_force_load
	jp nz,load_problem
