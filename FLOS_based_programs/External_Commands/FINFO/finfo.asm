;---------------------------------------------------------------------------------------
; App: "FINFO.EXE" - Shows file info (size and load addr, bank if header applied) Also
; sets an environment variable called FSIZ with size  - v1.01 By Phil @ retroleum
;
