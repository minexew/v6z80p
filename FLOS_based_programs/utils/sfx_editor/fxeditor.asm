...
;---------------------------------------------------------------------------------------
          ...
          include "FLOS_based_programs\code_library\fx_player\inc\fx_player.asm"
...
packed_sprites                incbin "FLOS_based_programs\utils\sfx_editor\data\sprites_packed.bin"
...
;--------------------------------------------------------------------------------
; END - Dont put any code or data after this point. Uused internally for buffers.
;--------------------------------------------------------------------------------
