...
tetris_logo	incbin "tetris_l.bin"

ts_spdefs		db 0,$56,$73,$b4,$41,$45,$05,$a4

sin_table	   	incbin "sin_tabl.bin"

title_text_map	incbin "title_te.bin"
...
tiles		incbin 	"tiles_ch.bin"

tiles_colours	incbin	"tiles_pa.bin"

charmap		incbin	"map_scre.bin"
