...
fx_data		incbin "FLOS_based_programs\code_library\FX_player\demo\demo_data\my_fx1.dat"
	
sample_data	incbin "FLOS_based_programs\code_library\FX_player\demo\demo_data\my_fx1.sam"
