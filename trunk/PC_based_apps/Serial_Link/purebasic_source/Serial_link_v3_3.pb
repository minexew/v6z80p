...
; By Phil Ruston '08-09. 8N1, no hardware flow control. v3.3 (14400,28800 BAUD options added)
...
EndEnumeration
  ...
  If OpenWindow(#Window_0, 314, 107, 330, 210,  "xZ80P Serial Link V3.3", #PB_Window_SystemMenu | #PB_Window_TitleBar)
        ...
        TextGadget(#Text_0, 10, 70, 309, 100, "", #PB_Text_Border)
        ComboBoxGadget(#Combo_1, 220, 40, 100, 24)
        ComboBoxGadget(#Combo_0, 220, 10, 100, 24)
        For a=1 To 9 : AddGadgetItem(#Combo_0,-1,"COM"+Str(a)+":") : Next
        AddGadgetItem(#Combo_1,-1,"14400 BAUD")
        AddGadgetItem(#Combo_1,-1,"28800 BAUD")
        AddGadgetItem(#Combo_1,-1,"57600 BAUD")
        AddGadgetItem(#Combo_1,-1,"115200 BAUD")
        SetGadgetState(#Combo_0,0)
        If baud$="115200"
         SetGadgetState(#Combo_1,3)
        EndIf
        If baud$="57600"
