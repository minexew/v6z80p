...
DoMessage("Phil's Utils..","Makes raw 16x16 sprites from a 256 colour Windows .BMP file." + Chr(13) + "Pic is scanned top To bottom, left To right" + Chr(13) , 0)

  If isGUI_Mode    
    skipzerotile$ = InputRequester("Phil's Utils..", "Want to skip all-zero 16x16 tiles?", "y")
  Else
    skipzerotile$ = ProgramParameter(5);    
  EndIf
