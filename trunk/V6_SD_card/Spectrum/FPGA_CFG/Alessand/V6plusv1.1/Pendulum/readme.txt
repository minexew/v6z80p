...
THESE EMULATORS ARE FOR V6Z80P+ v1.1(b)
WITH PENDULUM DAUGHTERBOARD ONLY.

Due to stability issues, various
builds of each core are offered. Use
the "_khs" versions first - if you
encounter problems, try the others.
