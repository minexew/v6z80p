; SDHC test 3, init and read first 256 sectors
...
;-----------------------------------------------------------------------------
	...
	call kjt_print_string
	ld hl,0
	ld (my_sector_lba0),hl
	ld (my_sector_lba2),hl
...
next_sector_lba
	...
	ld de,(my_sector_lba0+2)
	ld bc,1
	add hl,bc
	jr nc,secmswnc
	inc de
secmswnc	ld (my_sector_lba0),hl
	ld (my_sector_lba0+2),de
	pop bc
	ret
...
show_sector
	...
	push bc
	ld hl,sec2_txt
	ld a,(my_sector_lba0+3)
	call kjt_hex_byte_to_ascii
	ld a,(my_sector_lba0+2)
	call kjt_hex_byte_to_ascii
	ld a,(my_sector_lba0+1)
	call kjt_hex_byte_to_ascii
	ld a,(my_sector_lba0+0)
	call kjt_hex_byte_to_ascii
	ld hl,sec1_txt
	call kjt_print_string
	pop bc
...
verify	push bc
	ld hl,my_sector_buffer		;checks for data in flash-drive tester format
	ld b,128
	ld de,0
vlp1	ld a,(hl)
	inc hl
...
load_txt	db 11,11,"Loading..",11,11,0
