...
; Tests Extended Tile Mode - Single Playfield, 16x16 tiles - swap definitions test
...
;---------------------------------------------------------------------------------------------------
;copy 32 16x16 tile block definitins to VRAM $00000 and $40000
;---------------------------------------------------------------------------------------------------
	...
	ld hl,my_tiles
	ld de,video_base
	ld bc,$1000		; 16 * 256bytes = 4096
	ldir
	ld a,$20			
	ld (vreg_vidpage),a		; VRAM $40000 @ CPU $2000
	ld hl,my_tiles2
	ld de,video_base
	ld bc,$1000		; 16 * 256bytes = 4096
	ldir
