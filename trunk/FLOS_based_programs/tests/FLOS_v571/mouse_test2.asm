...
;--------------------------------------------------------------------------------------
	...
	call kjt_get_mouse_position		;before changing the mouse window size,
	jr nz,error			;check the mouse driver is installed
	ld hl,100				;max x
	ld de,100				;max y
	call kjt_enable_mouse		;reset mouse driver
...
text2	db "xxxx",11,"Mouse buttons :$"
text3	db "xx",11,11
