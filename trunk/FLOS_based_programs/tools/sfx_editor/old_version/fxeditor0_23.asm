;********************************************************
;* Sound FX Editor for FLOS V0.22 - By Phil Ruston 2010 *
;********************************************************
...
sfxed_txt	db "SOUND FX EDITOR 0.23 - TOP LEVEL        ",0
...
waved_txt	db "SOUND FX EDITOR 0.23 - WAVE SELECTOR    ",0
...
sample_load_txt
	...
	db "SOUND FX EDITOR 0.23 - SAMPLE LOADER    ",0
...
project_loadsave_txt
	...
	db "SOUND FX EDITOR 0.23 - DATA LOAD/SAVE   ",0
...
script_ed_txt
	...
	db "SOUND FX EDITOR 0.23 - SCRIPT EDITOR    ",0
