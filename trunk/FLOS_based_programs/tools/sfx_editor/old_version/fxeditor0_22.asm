...
sfxed_txt	db "SOUND FX EDITOR 0.22 - TOP LEVEL        ",0
...
waved_txt	db "SOUND FX EDITOR 0.22 - WAVE SELECTOR    ",0
...
sample_load_txt
	...
	db "SOUND FX EDITOR 0.22 - SAMPLE LOADER    ",0
...
project_loadsave_txt
	...
	db "SOUND FX EDITOR 0.22 - DATA LOAD/SAVE   ",0
...
script_ed_txt
	...
	db "SOUND FX EDITOR 0.22 - SCRIPT EDITOR    ",0
