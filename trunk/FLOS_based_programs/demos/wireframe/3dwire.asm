;---------------------------------------------------------------------------------------
; 3D Wire frame demo for V6Z80P.
; V1.01 by Phil Ruston 2008.
;
; Added video mode header and friendly quit to FLOS Dec 2012
;--------------------------------------------------------------------------------------- 
;
...
;=============================================================================================================
                    ...
                    include   "flos_based_programs\demos\wireframe\inc\3d_obj_cube.asm"
                    include   "flos_based_programs\demos\wireframe\inc\3d_obj_icosahedron.asm"
                    include   "flos_based_programs\demos\wireframe\inc\3d_obj_cube_star.asm"
                    include   "flos_based_programs\demos\wireframe\inc\3d_obj_frame.asm"
                    include   "flos_based_programs\demos\wireframe\inc\3d_obj_glass.asm"
                    include   "flos_based_programs\demos\wireframe\inc\3d_obj_tiefighter.asm"
                    include   "flos_based_programs\demos\wireframe\inc\3d_obj_question.asm"
...
sin_table           incbin "flos_based_programs\demos\wireframe\data\sine_table.bin"
...
star_defs           incbin "flos_based_programs\demos\wireframe\data\stars_sprites.bin"
...
fontdata            incbin "flos_based_programs\demos\wireframe\data\font_chunky.bin"

font_cols           incbin "flos_based_programs\demos\wireframe\data\font_12bit_palette.bin"

;--------------------------------------------------------------------------------------------------------------

logo_cols           incbin "flos_based_programs\demos\wireframe\data\logo_palette.bin"

logo_gfx            incbin "flos_based_programs\demos\wireframe\data\logo_sprites.bin"
...
;--------------------------------------------------------------------------------------------------------------
                    ...
                    include "flos_based_programs\demos\wireframe\inc\Z80_Protracker_Player.asm"
                    include "flos_based_programs\demos\wireframe\inc\Amiga_audio_to_V5Z80P.asm"

          
                    org (($+2)/2)*2               ; word align

music_module        incbin "flos_based_programs\demos\wireframe\data\tune.pat"

music_samples       incbin "flos_based_programs\demos\wireframe\data\tune.sam"
end_of_samples      db 0
