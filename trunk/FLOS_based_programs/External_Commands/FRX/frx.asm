...
serial_error	ld hl,serial_error_text
		call kjt_print_string
		xor a
		ret

save_error	ld hl,save_error_text
		call kjt_print_string
		xor a
		ret	
