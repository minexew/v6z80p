...
#define KJT_SET_SECTOR_AND_DEV	   OS_START+0xaf
...
#define KJT_MOUNT_VOLUMES		   OS_START+0xdc	 // added in flos v562
#define KJT_GET_DEVICE_INFO		   OS_START+0xdf   // added in flos v565
