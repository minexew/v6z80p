; test tilemap mode with sprites - full line count values for AMOEBA v67
...
;-------------------------------------------------------------------------------------------------
			...
			ld a,00001100b						
			out0 (port_video_mode),a			; tilemap mode + wide border for scrolling
			ld a,00000001b
			out0 (41h),a						; enable sprites
			ld a,0
			out0 (42h),a						; use bank 0 palettes
