...
; Writes 4 channels to left channels
;----------------------------------------------------------------------------------------
...
;---------------------------------------------------------------------------------------------------------------
				...
				inc hl
				ld d,(hl)
				ld.lil (ix+28h),de					;update chan 1
				...
				inc hl
				ld d,(hl)
				ld.lil (ix+68h),de					;update chan 3
...
;---------------------------------------------------------------------------------------------------------------
				...
				ld e,a
				ld.lil (ix+2ch),de					;ch1		
					
				ld a,(thirdchan_volume)
				ld e,a
				ld.lil (ix+4ch),de					;ch2
			
				ld a,(fourthchan_volume)
				ld e,a
				ld.lil (ix+6ch),de					;ch3
...
;---------------------------------------------------------------------------------------------------------------
				...
				add.l hl,hl
				ld.lil (ix+00h),hl					;update chan 0 - loc (24 bit write mandatory)
				ld.lil hl,0
				ld hl,(firstchan_loop_loc)
				add.l hl,hl
				ld.lil (ix+10h),hl					;update chan 1 - loop loc
				ld.lil hl,0
				ld hl,(firstchan_length)
				add.l hl,hl
				ld.lil (ix+04h),hl					;update chan 2 - len
				ld.lil hl,0
				ld hl,(firstchan_loop_len)
				add.l hl,hl
				ld.lil (ix+14h),hl					;update chan 3 - loop len
