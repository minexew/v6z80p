...
WORKDIR = E:\MY_OWN~1\Coding\EZ80PR~1\Code\PROSEA~1\AUDIO3~3\Debug
...
OUTDIR = E:\MY_OWN~1\Coding\EZ80PR~1\Code\PROSEA~1\AUDIO3~3\Debug
...
clean: 
	...
	@if exist $(WORKDIR)\audtest.map  \
            $(RM) $(WORKDIR)\audtest.map
	@if exist $(WORKDIR)\phase_test.obj  \
            $(RM) $(WORKDIR)\phase_test.obj
...
OBJS =  \
            $(WORKDIR)\phase_test.obj

audtest: $(OBJS)
	 $(LD) $(LDFLAGS)

$(WORKDIR)\phase_test.obj :  \
            E:\MY_OWN~1\Coding\EZ80PR~1\Code\PROSEA~1\AUDIO3~3\src\phase_test.asm
	 $(AS) $(ASFLAGS) E:\MY_OWN~1\Coding\EZ80PR~1\Code\PROSEA~1\AUDIO3~3\src\phase_test.asm
