...
; ----------------
;
; Fixed bug introduced in 6.12 where loader would attempt to load from card even
; if there is no .osf file (had inadvertantly removed a "jr nz" after find_file)
; 
; --------------------------------------------------------------------------------------------------
;
...
welcome_txt	db "V6Z80P BY PHIL RUSTON 2008-2010",11,11,"BOOTCODE:V6.13 - OSCA HW:V",0
