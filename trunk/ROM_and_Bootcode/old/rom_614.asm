;------------------------------------------------------------------------------------
; V6Z80P ROM code v6.14 - Compile with PASM0. This requires OSCA 660+
;------------------------------------------------------------------------------------
;
...
start_delay
	...
	ld hl,0				; wait ensures config PIC is ready for commands
sdlp	inc hl
	ld a,h
	or l
	jr nz,sdlp
...
;------------------------------------------------------------------------------------------
	...
	db 0,"ROM614"			; just ID bytes - not essential