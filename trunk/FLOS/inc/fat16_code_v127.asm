...
;----------------------------------------------------------------------------------------------
;
; Changes:	1.27 - When scanning dirs, if a $00 byte is @ filename on disk, this is taken as end of dir
;		1.26 - Optimization: Added "fs_test_dir_cluster" routine to check for root dir
...
fs_ststr	ld a,(de)				; if first char = $00, this is the end of the dir
		or a
		jr z,fnnotfnd
		ld iy,fs_sought_filename		; search type = 0 find filename string
