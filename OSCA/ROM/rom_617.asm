;------------------------------------------------------------------------------------
; V6Z80P ROM code v6.17 - Compile with PASM0. Requires OSCA 673+
;------------------------------------------------------------------------------------
;
; Changes: v6.17 - sets the linecop addr bits [18:16] high for backwards compatibility
;
...
eeprom_bcode	ld a,%10000111
		ld (vreg_palette_ctrl),a	; set linecop to use 70000-7ffff by default
		ld a,$80
