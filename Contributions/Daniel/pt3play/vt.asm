...
;patches by Daniel Illgen:
; now compiles with pasmo: (IX-12+constant) replaced with (IX+newconst)
; inserted hooks for pt3play
...
TP_2	LD A,H
	...
	LD A,(IX-100-13) ;EXTRACT VERSION NUMBER
	SUB #30
	JR C,L20
	CP 10
	JR C,L21
...
;IX for PTDECOD here (+12)
CHP.OffOnD	EQU $C  ;DB 0
CHP.OrnPtr	EQU $D  ;DW 0
CHP.SamPtr	EQU $F  ;DW 0
CHP.NNtSkp	EQU $11 ;DB 0
CHP.Note	EQU $12 ;DB 0
CHP.SlToNt	EQU $13 ;DB 0
CHP.Env_En	EQU $14 ;DB 0
CHP.Flags	EQU $15 ;DB 0
 ;Enabled - 0,SimpleGliss - 2
CHP.TnSlDl	EQU $16 ;DB 0
CHP.TSlStp	EQU $17 ;DW 0
CHP.TnDelt	EQU $19 ;DW 0
CHP.NtSkCn	EQU $1B ;DB 0
CHP.Volume	EQU $1C ;DB 0
