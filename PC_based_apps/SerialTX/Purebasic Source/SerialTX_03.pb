...
;
; V0.03 - Allow 14400 and 28800 BAUD
...
If srcfile$=""
 PrintN("SerialTX.exe v0.03 - Send file via command line to FLOS")
 PrintN(" ")
 PrintN("USE: SerialTX filename [com] [baud]")
 PrintN(" ")
 PrintN ("    com = 'COM1' To 'COM9', if not supplied first working COM port will be used.")
 PrintN ("    baud = 14400, 28800, 57600 or 115200, if not supplied baud set at 115200")
 Delay (5000)
 Goto normal_quit
 EndIf
...
If baud$ = ""
 baud$ = "115200"
EndIf
If baud$ <> "115200" And baud$ <> "57600" And baud$ <> "28800" And baud$ <> "14400"
