; test tilemap mode with audio + sprites - AMOEBA v80
...
;---------------------------------------------------------------------------------------------
			...
			ld a,1
			ld (video_control_regs),a			; disable spites/tilemap. Enable 16 colour mode.
			ld a,0
			ld.lil (audio_regs+3),a				; Disable audio playback
...
;-------------------------------------------------------------------------------------------------
			...
			ld a,00001100b						
			ld (video_control_regs),a			; tilemap mode + wide border for scrolling
			ld a,00000001b
			ld (video_control_regs+1),a			; enable sprites
			ld a,0
			ld (video_control_regs+2),a			; use bank 0 palettes
...
;-----------------------------------------------------------------------------------------------
			...
			include "ADL_mode_Protracker_Player_v101.asm"
	
			include "ADL_mode_Protracker_to_EZ80P_audio.asm"
